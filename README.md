...
A microcontroller-based security system using **PIC16F877A**, 4x4 keypad, and 16x2 LCD display. Users must enter the correct password to activate the output (LED). Ideal for home, office, or bank security applications.
...
This security system is built around the **PIC16F877A** microcontroller. It uses a 4x4 keypad for password input and a 16x2 LCD for user feedback. When the correct password is entered, an LED blinks to indicate successful access.
...
| 33pF Capacitors | 2 | Crystal oscillator |
...
5. If wrong: System resets and asks for password again
...
- Add wireless connectivity (GSM/BT)
- Store access logs
